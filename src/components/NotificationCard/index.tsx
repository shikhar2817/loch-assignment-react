...
const Notification: React.FC<INotification> = ({
    ...
    const getIcon = (icon: INotification['icon']) => {
        switch (icon) {
            case 'bell': return <LuBell style={{ width: "28px", height: "28px" }} />
            case 'clock': return <BsClock style={{ width: "28px", height: "28px" }} />
            case 'stats': return <LuBarChart2 style={{ width: "28px", height: "28px" }} />
        }
    }

    const getAction = (action: INotification['action']) => {
        switch (action) {
            case "check": return <div className="inline-flex items-center">
            ...
            case "save": return <p className='save'>Save</p>
